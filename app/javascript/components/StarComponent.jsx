...
const StarDefsComponent = () => (
    <defs>
        ...
        <linearGradient id="paint-gradient-full-star" x1="0" y1="0" x2="0" y2="14.9972" gradientUnits="userSpaceOnUse">
            <stop stopColor="#FFCD69"/>
            <stop offset="1" stopColor="#FDCE71"/>
        </linearGradient>
        <linearGradient id="paint-gradient-half-star">
            <stop offset="51%" stopColor="#FFCD69"/>
            <stop offset="49%" stopColor="#E0E0E0"/>
        </linearGradient>
    </defs>
)

const STAR_TYPES = {
    'EMPTY': {svgFill: '#E0E0E0', className: 'star-empty'},
    'FULL': {svgFill: 'url(#paint-gradient-full-star)', className: 'star-full'},
    'HALF': {svgFill: 'url(#paint-gradient-half-star)', className: 'star-half'}
}

export const StarComponent = ({ on, starType, includeSvgDefs }) => (
    <span className={'star ' + STAR_TYPES[starType || (on ? 'FULL' : 'EMPTY')].className }>
        <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g filter="url(#filter-star)">
                <path fillRule="evenodd" clipRule="evenodd"
                      ...
                      fill={ STAR_TYPES[starType || (on ? 'FULL' : 'EMPTY')].svgFill }
                />
            </g>
            { includeSvgDefs ? <StarDefsComponent /> : null }
        </svg>
    </span>
)